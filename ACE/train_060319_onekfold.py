...
sig_traindata[sig_sigsidebins==2]
...
print([np.sum((sig_sigsidebins == i)[:numsig])/np.sum(bg_sigsidebins == i) for i in range(1,4)])
...
# all_traindata = all_traindata[np.logical_and(all_sigsidebins > 0,
#                                              all_sigsidebins < 4)]
# all_sigsidebins = all_sigsidebins[np.logical_and(all_sigsidebins > 0,
#                                                  all_sigsidebins < 4)]
...
#                                     period=50,
#                                     training_data=data_valid,
#                                     training_labels=labels_valid,
#                                     preprocess=preprocess,
#                                     rates=rates,
#                                     colors=colors,
#                                     mode = "show",
