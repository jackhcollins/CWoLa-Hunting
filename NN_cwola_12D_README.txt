NN_cwola_12D.py will train the NNs for a single signal region choice. It will save the NNs, and save a variety of plots including:
...
python NN_cwola_12D.py -tag1 argument1 -tag2 argument2 ...
...
-kfolds: number of kfolds to use. Default is 5.
...
python NN_cwola_12D.py -o /output_directory/prefix -sigevnts 375 -bgevnts 78000 -checkeff 0.01 -bin 7
